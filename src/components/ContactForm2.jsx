        ...
        <div>
          <form className="gap-4 grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="flex lg:flex-row flex-col lg:justify-between justify-start">
              ...
              <button
                type="submit"
                className="mt-12 flex items-center justify-center lg:ml-[40%] ml-0  bg-[#fcc800] text-black lg:w-[108px] w-full px-6  py-2 rounded-3xl font-bold hover:bg-yellow-600"
              >
                Send
